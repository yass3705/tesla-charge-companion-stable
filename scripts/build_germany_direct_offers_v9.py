...
def main():
 a=argparse.ArgumentParser();a.add_argument('--base',default='data/v9/germany-direct-offers.json');a.add_argument('--extensions',nargs='*',default=['data/v9/germany-direct-offers-aral-extension.json','data/v9/germany-direct-offers-enbw-extension.json','data/v9/germany-direct-offers-swu-extension.json','data/v9/germany-direct-offers-westfalen-extension.json']);a.add_argument('--out',default='build/germany-direct-offers.json');x=a.parse_args()
