...
# Ewiva is intentionally enriched in a dedicated commercial layer so Enel X Way
# direct/subscription counts remain deterministic and EWI never masquerades as ENX.
