...
for op in ('EnBW mobility+','SWU Energie','Westfalen','EAM Natur Energie','Stadtwerke Bochum','Mark-E','Stadtwerke Konstanz','Stadtwerke Bruchsal','JOLT Energy','Stadtwerke Heidelberg','Stadtwerke Rüsselsheim','Stadtwerke Witten','Albwerk','Stadtwerke Bielefeld'):
