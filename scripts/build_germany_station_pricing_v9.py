...
DEFAULT_SEEDS=['data/v9/germany-station-pricing-seed.json','data/v9/germany-station-pricing-seed-extension-2.json','data/v9/germany-station-pricing-seed-extension-3.json','data/v9/germany-station-pricing-enni-extension.json','data/v9/germany-station-pricing-seed-extension-4.json','data/v9/germany-station-pricing-seed-extension-5.json']
