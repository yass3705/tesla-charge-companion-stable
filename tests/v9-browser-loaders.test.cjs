...
const registry={sources:[
  ...
  {id:'ionity',adapter:'direct-station-gzip',path:'data/ionity.json.gz',priority:{tariff:95},active:true},
  {id:'atlante',adapter:'direct-station-gzip',path:'data/atlante.json.gz',priority:{tariff:95},active:true},
...
assert.deepEqual(calls,[
  ...
  ['legacy-tariff','../data/e55c.json.gz','e55c'],
  ['legacy-station','../data/ionity.json.gz','ionity'],
  ['legacy-station','../data/atlante.json.gz','atlante']
]);
