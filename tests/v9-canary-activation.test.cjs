...
console.log(JSON.stringify({ok:true,module:'tcc-v9-canary-activation',checks:['approved-one-percent','full-window-run','ready-state','stable-runtime','zero-rollbacks','blocked-readiness','changed-build','failed-validation','evidence-integrity']},null,2));
