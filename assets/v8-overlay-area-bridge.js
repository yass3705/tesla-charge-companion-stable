...
(function(){
  ...
  function loadTariffDisplay(){if(!window.TCCV8TariffDisplay&&!document.querySelector('script[data-tcc-tariff-display]')){const s=document.createElement('script');s.src='assets/v8-tariff-display-fix.js?v=rc48bm-20260825';s.defer=true;s.dataset.tccTariffDisplay='1';document.head.appendChild(s)}}
  function loadSubscriptionStability(){if(!window.TCCV8SubscriptionStability&&!document.querySelector('script[data-tcc-subscription-stability]')){const s=document.createElement('script');s.src='assets/v8-subscription-stability-fix.js?v=rc48bm-20260825';s.defer=true;s.dataset.tccSubscriptionStability='1';document.head.appendChild(s)}}
  ...
  function markRevision(){const banner=document.getElementById('tccPreviewBanner');if(banner&&/RC4\.8/.test(String(banner.textContent||'')))banner.textContent=`V8 Preview · RC4.8 · ${REVISION} · La Borne Bleue direct calculable · abonnements visibles · données canoniques France · auto-mise à jour désactivée`}
  ...
  console.info('[TCC V8] Pont overlay/cache rc48bm actif + garde-fou La Borne Bleue avant simulation.');
})();
