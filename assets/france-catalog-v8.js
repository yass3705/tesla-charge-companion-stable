...
(function(){
  ...
  function etotemMatchProfile(value){
  ...
  function mergeEtotemCatalog(catalog,data,origin={lat:0,lon:0},radiusKm=0){
    ...
    for(const record of records){
      ...
      for(let index=0;index<catalog.length;index++){
        ...
        const operatorLike=isEtotemOperator(station),nameScore=etotemNameScore(record,station),variantMatch=etotemVariantMatch(record,station),technical=etotemTechnicalMatch(record,station);if(!operatorLike&&distance>.02&&nameScore<2)continue;
