...
(function(){
  'use strict';
  const REVISION='rc48cd-pre-expansion-direct';
  ...
  function loadDirectOfferPipeline(){
    ...
    s.src='assets/v8-direct-offer-pipeline.js?v=v8-direct-offer-pipeline-3';s.defer=true;s.dataset.tccDirectOfferPipeline='1';document.head.appendChild(s);return true;
  }
  ...
  console.info('[TCC V8] rc48cd : pipeline direct pré-expansion et couche CPO France chargés.');
})();