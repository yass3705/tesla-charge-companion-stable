...
(function(){
  ...
  const refs=[
    ...
    {id:'smoys-direct',aliases:['SMOYS','Smoys','Réseau SMOYS','Reseau SMOYS'],provider:'SMOYS direct',label:'0,39 €/kWh · 8h–20h : 0,80 €/15 min après 15 min de post-charge · 20h–8h : pas de frais post-charge publié',note:'QR/CB et Ulys x SMOYS documentés. Pass Ulys x SMOYS : 6 € sans abonnement mensuel ; l’itinérance tierce peut ajouter des frais. Hors classement car la facturation du parking par tranches de 15 min n’est pas encore modélisée de façon exacte.'},
