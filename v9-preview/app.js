(async function(){
  ...
  $('load').addEventListener('click',async()=>{
    try{
      ...
      const area=await engine.queryArea({countryCode,origin:{lat,lon},radiusKm,filters:{},subscriptionFilters:{minCountries:Number($('minCountries').value||1),countryCodes,coverageMode:'all'}});
